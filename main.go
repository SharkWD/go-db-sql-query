...
func main() {
	...
	newClient := Client{
		FIO:      "Шатохин Виктор Викторович", // укажите ФИО
		Login:    "shatohin",                  // укажите логин
		Birthday: "19700808",                  // укажите день рождения
		Email:    "shatohin@yandex.ru",        // укажите почту
	}
	...
	newLogin := "shatnew" // укажите новый логин
